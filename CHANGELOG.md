...
- Add Windows Web Account Manager (WAM) support for authentication in development.

## [2.5.1] - 2026-06-16

### Fixed

- Fix bug in handling of empty role claim.

## [2.5.0] - 2026-01-13

### Fixed

- Fixed issue where multiple groups were not assigned correctly.
